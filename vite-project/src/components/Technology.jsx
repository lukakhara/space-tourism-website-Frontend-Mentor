...
function Technology() {
  ...
  if (!technologies) {
    return (
      <div className="min-h-screen bg-blue-900 flexCenter text-[2rem] text-white">
        Loading...
      </div>
    );
  }
    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative flex-1 flex flex-col  ">
        <main className=" text-white  mx-6 mt-6 mb-12 md:m-[40px]">
          <h2
            className=" w-full font-barlowC tracking-[15%]    md:text-[1.25rem]  2xl:text-[1.75rem]  
          ...
          <div className=" w-full flex 2xl:flex-row flex-col  gap-[2rem]  2xl:gap-[2rem]">
            <div
              className=" flex-1 gap-[2.5rem]   2xl:gap-[4rem] 2xl:p-0 2xl:flex-row 2xl:w-1/2 order-2
            ...
            >
              ...
              <div className="order-1  max-w-md flex flex-col gap-8 font-bellefair">
                <h2 className="text-18  md:text-md  2xl:text-xl opacity-[50.42%] ">
                  THE TERMINOLOGY...
                </h2>
                <h1 className="text-md    md:text-[2.5rem]  2xl:text-[3.5rem]">
                  {technology.name.toUpperCase()}
                </h1>
                <p className="text-xs  md:text-sm   2xl:text-18 text-blue-600 leading-[180%]">
